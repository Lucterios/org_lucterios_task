...
// --- Last modification: Date 21 July 2010 9:15:04 By  ---
...
function Tasks_APAS_getGrid(&$self,$Params)
{
//@CODE_ACTION@
$grid = new Xfer_Comp_Grid("task");
$grid->setDBObject($self, array('title','description','end','owner','valueGraph'),"",$Params);
