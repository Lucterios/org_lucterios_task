...
// --- Last modification: Date 15 December 2011 0:26:08 By  ---
...
//@DESC@Fiche d'un groupe de taches
//@PARAM@ 
//@INDEX:Organisation
...
function Organisation_APAS_Fiche($Params)
{
...
$xfer_result->Caption="Fiche d'un groupe de taches";
...
//@CODE_ACTION@
	...
	$self->unlockRecord("Organisation_APAS_Fiche");
	throw $e;
}
return $xfer_result;
}
