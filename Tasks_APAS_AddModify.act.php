...
//@DESC@Ajouter/Modifier une tâche
...
$xfer_result->Caption="Ajouter/Modifier une tâche";
$xfer_result->m_context['ORIGINE']="Tasks_APAS_AddModify";
$xfer_result->m_context['TABLE_NAME']=$self->__table;
$xfer_result->m_context['RECORD_ID']=$self->id;
//@CODE_ACTION@
if ($self->id>0)
	$xfer_result->Caption="Modifier une tâche";
else
	$xfer_result->Caption="Ajouter une tâche";
